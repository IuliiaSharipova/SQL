...
-- 2.
-- Once you've made the tables, insert a student named Mark Watney (student_id=1) who has a phone number 
-- of 777-555-1234 and doesn't have an email. He graduates in 2035 and has 5 as a homeroom number.
...
INSERT INTO students(first_name, last_name, phone_number, graduation_year, homeroom_number)
VALUES ('Mark', 'Watney', '7775551234', '2035', 5);

-- 3.
-- Then insert a teacher names Jonas Salk (teacher_id = 1) who as a homeroom number of 5 and is from the Biology 
-- department. His contact info is: jsalk@school.org and a phone number of 777-555-4321.
INSERT INTO teachers(first_name, last_name,homeroom_number,department,phone_number,email)
